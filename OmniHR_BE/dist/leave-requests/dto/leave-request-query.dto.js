...
class LeaveRequestQueryDto extends pagination_query_dto_1.PaginationQueryDto {
    status;
    employeeId;
    departmentId;
    leaveTypeId;
...
__decorate([
    ...
    __metadata("design:type", String)
], LeaveRequestQueryDto.prototype, "fromDate", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], LeaveRequestQueryDto.prototype, "toDate", void 0);
